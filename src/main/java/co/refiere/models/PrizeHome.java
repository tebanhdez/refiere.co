...
/**
 * Home object for domain model class Prize.
 * @see co.refiere.models.Prize
 * @author Hibernate Tools
 */
public class PrizeHome {

    private static final Log log = LogFactory.getLog(PrizeHome.class);
    ...
    public void persist(Prize transientInstance) {
        log.debug("persisting Prize instance");
        try {
    ...
    public Prize merge(Prize detachedInstance) {
        ...
        try {
            Prize result = (Prize) sessionFactory.getCurrentSession().merge(detachedInstance);
    ...
    public Prize findById(int id) {
        ...
        try {
            Prize instance = (Prize) sessionFactory.getCurrentSession().get("co.refiere.models.Prize", id);
            if (instance == null) {
    ...
    public List findByExample(Prize instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession().createCriteria("co.refiere.models.Prize")
