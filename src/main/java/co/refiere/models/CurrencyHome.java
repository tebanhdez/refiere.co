 ...
 * @see co.refiere.models.Currency
...
public class CurrencyHome {
    ...
    public Currency merge(Currency detachedInstance) {
        ...
        try {
            Currency result = (Currency) sessionFactory.getCurrentSession().merge(detachedInstance);
    ...
    public Currency findById(int id) {
        ...
        try {
            Currency instance = (Currency) sessionFactory.getCurrentSession().get("co.refiere.models.Currency", id);
            if (instance == null) {
    ...
    public List findByExample(Currency instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession().createCriteria("co.refiere.models.Currency")
