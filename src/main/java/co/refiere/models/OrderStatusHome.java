 ...
 * @see co.refiere.models.OrderStatus
...
public class OrderStatusHome {
    ...
    public OrderStatus findById(int id) {
        ...
        try {
            OrderStatus instance = (OrderStatus) sessionFactory.getCurrentSession().get("co.refiere.models.OrderStatus",
                    id);
            if (instance == null) {
    ...
    public List findByExample(OrderStatus instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession().createCriteria("co.refiere.models.OrderStatus")
