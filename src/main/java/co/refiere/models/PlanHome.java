...
public class PlanHome {
    ...
    public Plan merge(Plan detachedInstance) {
        ...
        try {
            Plan result = (Plan) sessionFactory.getCurrentSession().merge(detachedInstance);
    ...
    public List findByExample(Plan instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession().createCriteria("co.refiere.models.Plan")
