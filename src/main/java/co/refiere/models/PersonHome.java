...
public class PersonHome {
    ...
    public Person findById(int id) {
        ...
        try {
            Person instance = (Person) sessionFactory.getCurrentSession().get("co.refiere.models.Person", id);
            if (instance == null) {
    ...
    public List findByExample(Person instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession().createCriteria("co.refiere.models.Person")
