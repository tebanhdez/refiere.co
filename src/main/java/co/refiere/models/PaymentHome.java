...
public class PaymentHome {
    ...
    public Payment merge(Payment detachedInstance) {
        ...
        try {
            Payment result = (Payment) sessionFactory.getCurrentSession().merge(detachedInstance);
    ...
    public Payment findById(int id) {
        ...
        try {
            Payment instance = (Payment) sessionFactory.getCurrentSession().get("co.refiere.models.Payment", id);
            if (instance == null) {
    ...
    public List findByExample(Payment instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession().createCriteria("co.refiere.models.Payment")
