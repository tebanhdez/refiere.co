...
public class CompanyHome {
    ...
    public Company findById(int id) {
        ...
        try {
            Company instance = (Company) sessionFactory.getCurrentSession().get("co.refiere.models.Company", id);
            if (instance == null) {
    ...
    public List findByExample(Company instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession().createCriteria("co.refiere.models.Company")
